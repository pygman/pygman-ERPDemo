			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td>登录时间</td>
						<td>
							<input type="text"  size="14" onfocus="c.showMoreDay=false;c.show(this);" value="${eqm.lastLoginTimeView}"  readonly="true"/>
							<s:hidden name="eqm.lastLoginTime"/>
						</td>
						<td>登录时间</td>
						<td>
							<input type="text" size="14" onfocus="c.showMoreDay=false;c.show(this);" value="${eqm.lastLoginTime2View}" readonly="true"/>
